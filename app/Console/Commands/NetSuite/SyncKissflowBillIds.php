...
class SyncKissflowBillIds extends Command
{
    protected $signature = 'kissflow:sync-bill-ids {--sheet=KF ID : Sheet name to read Kissflow IDs from}';
    ...
    {
        $this->info('Starting Kissflow Bill ID sync to Google Sheets...');
        ...
        try {
            ...
            $this->error('Error syncing Kissflow Bill IDs: ' . $e->getMessage());
